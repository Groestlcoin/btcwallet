...
const (
	defaultCAFilename       = "grsd.cert"
	defaultConfigFilename   = "grswallet.conf"
	defaultLogLevel         = "info"
	defaultLogDirname       = "logs"
	defaultLogFilename      = "grswallet.log"
...
var (
	btcdDefaultCAFile  = filepath.Join(btcutil.AppDataDir("grsd", false), "rpc.cert")
	defaultAppDataDir  = btcutil.AppDataDir("grswallet", false)
...
type config struct {
	...
	TestNet3      bool                    `long:"testnet" description:"Use the test Groestlcoin network (version 3) (default mainnet)"`
	...
	// RPC client options
	RPCConnect       string                  `short:"c" long:"rpcconnect" description:"Hostname/IP and port of grsd RPC server to connect to (default localhost:1444, testnet: localhost:17764, simnet: localhost:18556)"`
	CAFile           *cfgutil.ExplicitString `long:"cafile" description:"File containing root certificates to authenticate a TLS connections with grsd"`
	DisableClientTLS bool                    `long:"noclienttls" description:"Disable TLS for the RPC client -- NOTE: This is only allowed if the RPC client is connecting to localhost"`
	BtcdUsername     string                  `long:"grsdusername" description:"Username for grsd authentication"`
	BtcdPassword     string                  `long:"grsdpassword" default-mask:"-" description:"Password for grsd authentication"`
	...
	LegacyRPCListeners     []string                `long:"rpclisten" description:"Listen for legacy RPC connections on this interface/port (default port: 1441, testnet: 17766, simnet: 18554)"`
	LegacyRPCMaxClients    int64                   `long:"rpcmaxclients" description:"Max number of legacy RPC clients for standard connections"`
	LegacyRPCMaxWebsockets int64                   `long:"rpcmaxwebsockets" description:"Max number of legacy RPC websocket connections"`
	Username               string                  `short:"u" long:"username" description:"Username for legacy RPC and grsd authentication (if grsdusername is unset)"`
	Password               string                  `short:"P" long:"password" default-mask:"-" description:"Password for legacy RPC and grsd authentication (if grsdpassword is unset)"`
